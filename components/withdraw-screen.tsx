  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute top-20 right-4 w-32 h-32 rounded-full opacity-20 ${theme === "dark" ? "bg-red-500" : "bg-red-300"
      ...
      <div className="relative z-10 px-4 pt-safe-area-inset-top pt-12">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className={`p-2.5 rounded-xl ${theme === "dark" ? "bg-red-500/20 text-red-400" : "bg-red-100 text-red-600"
            }`}>
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-2">
            <div className={`w-8 h-1 rounded-full transition-all duration-300 ${showNetworkSelection ? (theme === "dark" ? "bg-red-500" : "bg-red-600") : "bg-green-500"
              }`}></div>
            <div className={`w-8 h-1 rounded-full transition-all duration-300 ${!showNetworkSelection ? (theme === "dark" ? "bg-red-500" : "bg-red-600") : (theme === "dark" ? "bg-gray-600" : "bg-gray-300")
              }`}></div>
            ...
            <>
              ...
              {accountData && (
                <div className={`p-4 rounded-xl border transition-all duration-300 ${theme === "dark"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${theme === "dark" ? "bg-blue-600/30 text-blue-400" : "bg-blue-100 text-blue-600"
                        }`}>
              ...
              <div className={`p-5 rounded-2xl border transition-all duration-300 ${theme === "dark"
                ...
                <div className="flex items-center justify-between mb-3">
                  <Label className={`text-sm font-semibold flex items-center gap-2 ${theme === "dark" ? "text-gray-200" : "text-gray-800"
                    ...
                    <div className={`p-1.5 rounded-lg ${theme === "dark" ? "bg-red-500/20 text-red-400" : "bg-red-100 text-red-600"
                      }`}>
