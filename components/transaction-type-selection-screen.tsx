...
export function TransactionTypeSelectionScreen({
  ...
  return (
    <div
      className={`h-full relative overflow-hidden flex flex-col ${theme === "dark"
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute top-20 right-4 w-40 h-40 rounded-full opacity-10 ${theme === "dark" ? "bg-blue-500" : "bg-blue-300"
      ...
      <div className="relative z-10 px-4 pt-12 pb-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <button
              ...
              className={`h-11 w-11 rounded-xl transition-all duration-200 active:scale-95 ${theme === "dark"
        ...
        <div className="space-y-4 flex-1">
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 text-left">
                  ...
                  >
                    Effectuez plusieurs dépôts simultanément via un fichier Excel ou saisie manuelle.
                  </p>
                  <div className="flex items-center gap-2">
                    <div
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${theme === "dark"
          ...
          {(!canUseMomoPay || !canProcessUSSDTransaction) && !canUseMobcashBetting && (
            <div className={`p-6 rounded-2xl border text-center ${theme === "dark"
              ...
              <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 ${theme === "dark"
                ? "bg-gray-700/50"
                : "bg-gray-100"
                }`}>
        ...
        {/* Information Card */}
        <div
          className={`mt-6 p-4 rounded-2xl ${theme === "dark" ? "bg-blue-900/20" : "bg-blue-50"
            }`}
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4
                className={`font-semibold mb-1 ${theme === "dark" ? "text-blue-400" : "text-blue-700"
                  }`}
              >
                Information importante
              </h4>
              <p
                className={`text-xs ${theme === "dark" ? "text-blue-300" : "text-blue-600"
                  }`}
              >
                {isDeposit
